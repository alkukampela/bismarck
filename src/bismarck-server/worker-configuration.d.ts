/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb46e63ebe07265ad02aebd377fd5c13)
// Runtime types generated with workerd@1.20260317.1 2026-02-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameStorage";
	}
	interface Env {
		LOGIN_TOKENS: KVNamespace;
		SES_URL: "https://email.eu-west-1.amazonaws.com/v2/email/outbound-emails";
		SES_REGION: "eu-west-1";
		ENVIRONMENT: string;
		DISABLE_EMAIL_SENDING: string;
		JWT_SECRET: string;
		SMTP_HOST: string;
		SMTP_USERNAME: string;
		SMTP_PASSWORD: string;
		CORS_ORIGIN: string;
		GAME_STORAGE: DurableObjectNamespace<import("./src/index").GameStorage>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SES_URL" | "SES_REGION" | "ENVIRONMENT" | "DISABLE_EMAIL_SENDING" | "JWT_SECRET" | "SMTP_HOST" | "SMTP_USERNAME" | "SMTP_PASSWORD" | "CORS_ORIGIN">> {}
}
